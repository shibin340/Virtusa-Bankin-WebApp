  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown active">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item active" href="<%=request.getContextPath() %>/betwAcc">Between Accounts</a>
...
<div class="container">
  <% String id = (String)session.getAttribute("id"); 
				...
				<div class="jumbotron jumbotron-fluid">
  					<div class="container">
    				<h1 class="display-4">LOCAL TRANSFER</h1>
  					</div>
				</div>
  	<form action="<%=request.getContextPath() %>/betwAcc" method="post">
        <label>1. Choose an account to transfer from:</label><br>
		<select class="form-control" name="fromacc">
  			<option>Current</option>
  			<option>Savings</option>
		</select><br>
  		<label>2. Choose an account you would like to transfer to:</label><br>
